document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".g-i-navigation-list");
  const headerRef = document.querySelector(".g-i-header");
  const navigationRef = document.querySelector(".g-i-navigation");
